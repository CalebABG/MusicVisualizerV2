...
object Controls {
    lateinit var tabCaptionLabelFont: ControlFont
    ...
    fun setupControls() {
        ...
        slidersGroup.captionLabel.align(CENTER, CENTER)
        ...
        musicQueueGroup.captionLabel.align(CENTER, CENTER)
...
//                .setWidth(295)
        ...
        createButton(musicQueueGroup, "pause-song", 0f, 2 * btnOffset + btnSpacingY, bw, bh).addListener { p0 ->
            run {
                visRef.get()!!.togglePlay()
            }
        }

        createButton(musicQueueGroup, "mute-song", bw + btnSpacingX, 2 * btnOffset + btnSpacingY, bw, bh).addListener { p0 ->
            run {
        ...
        createButton(musicQueueGroup, "play-selected", 0f, 6 * btnOffset + btnSpacingY + 10, bw, bh).addListener { _ ->
            run {
